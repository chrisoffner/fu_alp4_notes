...
public class Peer {
    ...
    /**
     * only call in initialization to connect the existing network Connects to the
     * know Peer, receives the addresses of all other Peers in the network and
     * establishes all PeerConnections
     * 
     * @param firstPeerHost
     * @param firstPeerPort
     * @throws IOException
     */
    private void connectToFirstPeer(String firstPeerHost, int firstPeerPort) throws IOException {
        ...
        switch (command.strip().toLowerCase()) {
            case "create":
                ...
                try {
                    ...
                    System.out.println(String.format("Created %s, now you can \"put\" the Shape onto the Whiteboard.",
    ...
    /**
     * after successful initialization of Peer, it can start listening for new Peers
     * and do edits on the Whiteboard
     * 
     * @throws IOException
     */
